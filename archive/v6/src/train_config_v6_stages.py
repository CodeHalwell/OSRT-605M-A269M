"""v6 stage configs, archived when the repo focused on v7.

Pretrain-extend x3, LoopFix x2, MOPD, SystemSFT, Midtrain x6, SFT v1-v4 /
Long / Refresh / Math, GRPO x4. Nothing in the live tree imported these; the
only classes still in use are PretrainConfig and V7SanityConfig.

Reference only — not importable from this path.
"""
