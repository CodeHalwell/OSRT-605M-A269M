...
def build_config(preset: dict = OSRT_V7, **overrides) -> OSRTConfig:
    """Build an OSRTConfig from a preset. Defaults to the committed v7 shape;
    OSRT_605M_A288M is retained only as the historical base OSRT_V7 derives
    from — the v6 lineage itself lives in archive/v6/."""
